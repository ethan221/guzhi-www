...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface {
	 ...
	 */
	public static function find($id, $columns = array('*'), $read = true)
	{
		$instance = new static;

		return $instance->newQuery($read)->find($id, $columns);
	}
	 ...
	 * @return \Illuminate\Database\Eloquent\Builder|static
	 */
	public function newQuery($excludeDeleted = true, $read = true)
	{
		$builder = new Builder($this->newBaseQueryBuilder($read));
	 ...
	 */
	protected function newBaseQueryBuilder($read = true)
	{
	 ...
	 */
	public function getConnection($read = true)
	{
                                    if($read){
