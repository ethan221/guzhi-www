...
require_once(CLASS_PATH."QQURL.class.php");
...
class Oauth{
    ...
    public function qq_login(){
        $appid = trim($this->recorder->readInc("appid"));
        $callback = trim($this->recorder->readInc("callback"));
    ...
    public function get_userinfo(){
                ...
                $keysArr = array(
                    "access_token" => $this->recorder->read("access_token"),
                    'openid' => $openid,
                    'oauth_consumer_key' => trim($this->recorder->readInc("appid"))
                );
                ...
                if(isset($user->error)){
                        ...
                        $this->error->showError($user->ret, $user->msg);
                }else{
                        $user->open_id = $openid;
                }
                return (array)$user;
