<?php
class ControllerCommonAccountHeader extends Controller {
	public function index() {
		...
		foreach ($categories as $category) {
			if ($category['top']) {
				...
				$data['categories'][] = array(
					...
					'href'     => $this->url->link('product/category', 'cid=' . $category['category_id'])
				);
			}
		}
		...
		return $this->load->view('common/account_header', $data);
	}
}
