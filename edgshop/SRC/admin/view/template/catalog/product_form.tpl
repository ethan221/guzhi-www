          ...
          <div class="tab-content">
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left">
                                   <?php if($product_option['type'] == 'image'){ ?>
                                        <div class="form-group">
                                        <div class="col-sm-10">
                                            <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_text]" value="<?php echo $product_option_value['option_value_text']; ?>" placeholder="<?php echo $entry_option_value; ?>" class="form-control" />
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      ...
                      <td class="text-center">
                          <select name="product_image[<?php echo $image_row; ?>][product_option_value_id]" class="form-control">
                              <option>选择显示选项</option>
                              <?php if($product_options && $product_option['product_option_value']){ ?>
                              <?php foreach($product_options as $product_option){ ?>
                                    <?php if($product_option['type'] == 'image'){ ?>
                                        <?php foreach($product_option['product_option_value'] as $product_option_value){ ?>
                                        <option <?php if($product_image['product_option_value_id'] == $product_option_value['product_option_value_id']){ ?>selected="selected"<?php } ?> value="<?php echo $product_option_value['product_option_value_id']; ?>"><?php echo $product_option_value['option_value_text']; ?></option>
                                        <?php } ?>
                                    <?php } ?>
                              <?php } ?>
                              <?php } ?>
                ...
                <select id="product_option_ids<?php echo $image_row; ?>" style="display: none;">
                        <option>选择显示选项</option>
                         <?php if($product_options && $product_option['product_option_value']){ ?>
                              <?php foreach($product_options as $product_option){ ?>
                                    <?php if($product_option['type'] == 'image'){ ?>
                                        <?php foreach($product_option['product_option_value'] as $product_option_value){ ?>
                                        <option value="<?php echo $product_option_value['product_option_value_id']; ?>"><?php echo $product_option_value['option_value_text']; ?></option>
                                        <?php } ?>
                                    <?php } ?>
                              <?php } ?>
                              <?php } ?>
...
//[product_option_value][<?php echo $option_value_row; ?>][value]

function addOptionValue(option_row) {
                  var type = $('#tab-option input[name=\'product_option['+option_row+'][type]\']').val();
	html  = '<tr id="option-value-row' + option_value_row + '">';
                  if(type=='image'){
                        html += '	<td class="text-left"><div class="form-group">';
                        html += '	  <div class="col-sm-10"><input type="text" name="product_option[' + option_row + '][product_option_value]['+option_value_row+'][option_value_text]" value="" placeholder="<?php echo $entry_option_value; ?>" id="input-value' + option_row +'-'+ option_value_row + '" class="form-control" /></div>';
                        html += '	</div></td>';
                  }else{
...
var image_total_row = <?php echo $image_row; ?>;
...
function addImage() {
	...
	//2016-04-26
                  html += '  <td class="text-center"><select name="product_image[' + image_row + '][product_option_value_id]" class="form-control">';
                  html += $('#product_option_ids' + image_total_row).html();
                  html += '  </select></td>';
