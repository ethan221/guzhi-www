        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-order-no">订单编号</label>
                <input type="text" name="filter_order_no" value="<?php echo $filter_order_no; ?>" placeholder="订单编号" id="input-order-no" class="form-control" />
              </div>
              <div class="form-group">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.order_no') { ?>
                    <a href="<?php echo $sort_order_no; ?>" class="<?php echo strtolower($order); ?>">订单编号</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_order_no; ?>">订单编号</a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a> <a href="<?php echo $order['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                    </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
