...
class ModelCatalogOption extends Model {
	...
	public function editOption($option_id, $data) {
                                    ...
                                    if($data['type']!='image'){
                                            ...
                                            if('image' == $option['type']){
                                                    $this->resetProductImageByOptionId($option_id);
                                            }
                                    }
	...
	public function deleteOption($option_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "option_value_description WHERE option_id = '" . (int)$option_id . "'");
                  ...
                  protected function resetProductImageByOptionId($option_id){
                          //2016-04-26:更新产品图片显示属性
                          $this->db->query("UPDATE FROM `" . DB_PREFIX . "product_image` SET product_option_value_id=0 WHERE option_id = '" . (int)$option_id);
                  }
